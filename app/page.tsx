        ...
        <div className="flex-col px-4">
          ...
          <div className="my-4 flex flex-wrap justify-evenly">
            <div className=" whitespace-nowrap">
              ...
              <p className="inline text-nowrap text-content">@JyeStillitano</p>
            </div>
            <div className=" whitespace-nowrap">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="inline text-nowrap text-content">@Jye Stillitano</p>
            </div>
            <div className=" whitespace-nowrap">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="inline text-nowrap text-content">
