    ...
    <div className="m-auto h-full max-w-5xl">
      ...
      <div className="mx-4 mb-8 flex-grow rounded-xl border-[2px] border-accent p-4 shadow-lg sm:mx-12 md:mx-24 lg:mx-36">
        ...
        <div className="flex-col px-4">
          ...
          <p className="mx-auto my-4 max-w-96 text-center leading-7 text-primary">
          ...
          <p className="mx-auto max-w-96 text-center leading-7 text-primary">
          ...
          <Image
            ...
            height={480}
          />
          <p className="mb-4 text-center leading-7 text-primary">
          ...
          <div className="flex justify-center">
            ...
            <div className="relative left-[224px] top-3 h-3 w-3 rounded-full bg-primary" />
            <Link
              href="/projects"
          ...
          <div className="my-4 flex flex-wrap justify-evenly">
            <div className=" whitespace-nowrap">
              <svg
                ...
                viewBox="0 0 24 24"
                strokeWidth={1.5}
                className="mx-4 inline fill-primary stroke-primary"
              >
              ...
              <Link
                ...
                target="_blank"
                className="inline text-nowrap text-primary hover:underline"
              >
                @JyeStillitano
              </Link>
            </div>
            <div className=" whitespace-nowrap">
              <svg
                ...
                viewBox="0 0 50 50"
                strokeWidth={1.5}
                className="mx-4 inline h-8 w-8 fill-primary stroke-primary"
              >
            ...
            <div className=" whitespace-nowrap">
              <svg
                ...
                viewBox="0 0 24 24"
                strokeWidth={2}
                className="mx-4 inline h-8 w-8 stroke-primary"
              >
                <path
                  strokeLinecap="round"
            ...
            <a
              ...
              className="mt-4 text-center leading-7 text-primary hover:underline"
            >
